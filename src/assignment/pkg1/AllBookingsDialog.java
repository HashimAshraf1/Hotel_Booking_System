...
public class AllBookingsDialog extends JDialog {
    public AllBookingsDialog(JFrame parent, String title, boolean modal, List<Booking> bookings) {
        ...
        panel.add(new JLabel("<html><h2>All Bookings:</h2></html>", SwingConstants.CENTER)); 
        ...
        if (bookings.isEmpty()) {
            ...
            for (Booking booking : bookings) {
                ...
                JLabel bookingDetails = new JLabel("<html>" +
                    ...
                    "<b>Contact Info:</b> " + booking.getCustomer().getContactInfo() + "<br>" + // Add contact info here
                ...
                bookingPanel.setBorder(BorderFactory.createEmptyBorder(10, 0, 10, 0)); 
